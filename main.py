...
root = Tk()
image= ImageTk.PhotoImage(Image.open("vector2.png"))
height = 430
width = 530
...
root.config(bg='#2F6C60')

welcome_label = Label(text="BUS RESERVATION SYSTEM" , bg='#2F6C60' , font=("Trebuchet Ms",15,"bold"),fg='#FFFFFF')
